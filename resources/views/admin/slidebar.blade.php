<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            ...
            <center>
                <a href="#">
                    <img src="{{ asset('dashboard/assets/img/logo.png') }}" width="120px" height="80px" alt="" />
                </a>
            </center>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @endcan
            <li class="nav-item">
                <a class="nav-link {{ URL::current() == route('data', Auth::user()->user_token) ? 'active' : '' }}" href="{{ route('data', Auth::user()->user_token) }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ URL::current() == route('document') ? 'active' : '' }}" href="{{ route('document') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Tài liệu API</span>
                </a>
            </li>     
        </ul>
    </div>
